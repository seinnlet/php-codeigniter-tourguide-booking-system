              ...
              <div class="col-lg-6">
                <div class="p-5">
                  <div class="text-center">
                    <h1 class="h4 text-gray-900 mb-4 font-weight-bold">Update your password for Security!</h1>
                  </div>
                  <?php if ($this->session->userdata('role') == 'staff'): ?>
                    <form class="user" method="post" action="<?php echo base_url(); ?>index.php/Staff/updatepassword">
                  <?php elseif($this->session->userdata('role') == 'user'): ?>
                    <form class="user" method="post" action="<?php echo base_url(); ?>index.php/User/updatepassword">
                  <?php else: ?>
                    <form class="user" method="post" action="<?php echo base_url(); ?>index.php/Tourguide/updatepassword">
                  <?php endif ?>
                    ...
                    <button class="btn btn-primary btn-user btn-block font-weight-bold" type="submit" disabled id="btnchangepassword">
                      <big>Save</big>
                    </button>
