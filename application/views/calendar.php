...
<section class="py-5" id="booking">
  ...
  <div class="text-center my-3">
  	<a href="<?= base_url().'index.php/Tour/show/'.$this->uri->segment(3).'/'.$this->uri->segment(4).'/'.$this->uri->segment(5) ?>" class="btn btn-outline-secondary w-25 py-2">Cancel</a>
  </div>
